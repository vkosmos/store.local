                ...
                <div class="sngl-top">
                    <div class="col-md-5 single-top-left">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li data-thumb="images/<?=$v->img;?>">
                                    <div class="thumb-image"> <img src="images/<?=$v->img;?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 id="base-price" class="item_price" data-base="<?=$product->price * $curr['value'];?>">
                                <?=$curr['symbol_left']?>
                    ...
                    <div class="product-one">
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="product/<?=$v['alias'];?>" class="mask"><img class="img-responsive zoom-img" src="images/<?=$v['img'];?>" alt=""></a>
                                <div class="product-bottom">
                                    ...
                                    <p>Explore Now</p>
                                    <h4>
                                        <a class="item_add add-to-cart-link" href="cart/add?id=<?=$v['id'];?>" data-id="<?=$v['id'];?>"><i></i></a>
                            ...
                            <?php foreach($recentlyViewed as $v):?>
                                ...
                                <div class="col-md-4 product-left p-left">
                                    <div class="product-main simpleCart_shelfItem">
                                        ...
                                        <div class="product-bottom">
                                            <h3>
                                                <a href="product/<?=$v['alist'];?>"><?=$v['title'];?></a>
                                            </h3>
                                            <p>Explore Now</p>
                                            <h4>
                                                <a class="item_add add-to-cart-link" href="cart/add?id=<?=$v['id'];?>" data-id="<?=$v['id'];?>"><i></i></a>
